...
from apiShare.sqlQuery import PROC_SETTING_HOTEL_GET, PROC_SETTING_HOTEL_PUT
...
class THotel(TAPIIDBase):
    ...
    def modifyInfo(self, *args):
        try:
            body = {}
            if args[0] == 'PUT':
                value, rows, columns = self.db.resultDBQuery(PROC_SETTING_HOTEL_PUT % (args[1]["idx"],args[1]["is_pickup"],args[1]["is_24hour"],
