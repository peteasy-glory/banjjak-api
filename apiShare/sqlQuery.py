...
PROC_BEAUTY_BOOKING_BEAUTY_GALLERY_GET = "call procPartnerPC_Booking_BeautyGallery_get(%s, '%s')"
...
PROC_BEAUTY_BOOKING_COUPON_PUT = "call procPartnerPC_Booking_BeautyCoupon_put(%d, %d, %d, %d)"
...
PROC_SETTING_PERSONAL_VACATION_DELETE = "call procPartnerPC_Setting_Personal_Vacation_delete(%s)"
...
PROC_SETTING_BEAUTY_PART_TIME_DOG_PUT = "call procPartnerPC_Setting_BeautyPartTimeDog_put('%s',%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"
PROC_SETTING_BEAUTY_ADD_OPT_KIND_GET = "call procPartnerPC_Setting_BeautyAddOptionKind_get('%s','%s')"
PROC_SETTING_BEAUTY_ADD_OPT_DOG_GET = "call procPartnerPC_Setting_BeautyAddOption_get('%s','%s','%s','%s')"
...
PROC_SETTING_BEAUTY_CAT_PUT = "call procPartnerPC_Setting_BeautyCat_put('%s',%s,%s,'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"
...
PROC_SETTING_COUPON_GET = "call procPartnerPC_Setting_Coupon_get('%s','%s')"
